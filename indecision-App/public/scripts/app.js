    ...
    _createClass(IndecisionApp, [{
        ...
        value: function handleDeleteOption(option) {
            this.setState(function (prevState) {
                return {
                    options: prevState.options.filter(function (obj) {
                        return !(obj === option);
                    })
                };
            });
...
var AddOption = function (_React$Component2) {
    ...
    function AddOption(props) {
        ...
        _this2.handleSubmition = _this2.handleSubmition.bind(_this2);
    ...
    _createClass(AddOption, [{
        key: 'handleSubmition',
        value: function handleSubmition(e) {
            e.preventDefault();
...
ReactDOM.render(React.createElement(IndecisionApp, { options: ['derp', 'redlightDistrict', 'mami street'] }), document.getElementById('app'));
